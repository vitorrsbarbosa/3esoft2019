package br.unicesumar.aula20190319.pedido;
...
public class Pedido {
	...
	public double getValorTotal() {
		double total = 0.00;
//Vers�o 1: usando o getItens() para trabalhar com uma lista ao inv�s de um conjunto...		
...
//Vers�o 2: usando o conjunto itens diretamente em um for each...		
//		for (ItemPedido item : itens) {
//			total += item.getQuantidade() * item.getPreco() * (1-(item.getDescontoPercentual()/100));
//		}

		
//Vers�o 3: usando os dados como stream e com map/reduce com express�es lambda para calcular o total... 		
