package br.unicesumar.aula20190322.livro;
...
public class TestesComLivro {
	...
	public void testarNovoRepo() {
		...
		assertEquals("N�o deveria ter livros no repository novo!", 0, livros.size());
	}
	@Test
	public void testarRepoAdicionandoObjetos() {
		...
		assertEquals("N�o deveria ter livros no repository novo!", 3, livros.size());
	}
	@Test
