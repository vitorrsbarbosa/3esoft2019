package br.unicesumar.aula20190503.colecoes;
...
public class AppColecoes {
	...
	public static void main(String[] args) {
		...
		System.out.println("Nome na �ltima posi��o: " + nomes.get(nomes.size()-1) );
		...
		*/ 
		...
		System.out.println("Popula��o do Canad�: " + mapaDePopulacaoPorPais.get("CA"));
		System.out.println("Existe China? " + mapaDePopulacaoPorPais.containsKey("CN"));
		
		for (String sigla : mapaDePopulacaoPorPais.keySet()) {
			System.out.println("O pa�s " + sigla + " tem " + mapaDePopulacaoPorPais.get(sigla) + " habitantes");
		}
