package br.unicesumar.aula20190628.mapas;
...
public class App {
	...
	public static void main(String[] args) {
		...
		repo.salvar(new Imovel("Av. S�o Domingos", "123", wilsonMatos));
		repo.salvar(new Imovel("Av. S�o Domingos", "558", wilsonMatos));
		...
		System.out.println("Relat�rio de im�veis por propriet�rio");
